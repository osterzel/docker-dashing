...
ZABBIX_ENABLED = ENV['ZABBIX_ENABLED'] || 'false'

if ZABBIX_ENABLED != 'true'
  puts "Zabbix plugin disabled, set ZABBIX_ENABLED=true to enable"
else
  ...
  SCHEDULER.every '10s' do
    ...
    begin
      ...
      puts "Unable to connect to zabbix"
    end
