...
JIRA_ENABLED = ENV['JIRA_ENABLED'] || 'false'
PROJECT = ENV['JIRA_PROJECT'] || "jira-project"
RAPID_VIEW_ID = ENV['JIRA_RAPID_VIEW_ID'] || 0 
JIRA_USERNAME = ENV['JIRA_USERNAME'] || 'username'
JIRA_PASSWORD = ENV['JIRA_PASSWORD'] || 'password'
JIRA_SITE = ENV['JIRA_SITE'] || 'https://jira.atlassian.com'
JIRA_CONFIG = {
...
if JIRA_ENABLED != "true"
  puts "Jira plugin disabled, set JIRA_ENABLED=true to enable"
else
